...
define("RECAPTCHA_V3_SECRET_KEY", '6LdGIFMgAAAAACA0pCfwnbYwWsujuqKJS6x3xqMb');
...
function checkEmail($email, $myObj)
{
    ...
    //
    $conn = new mysqli("sql4.freemysqlhosting.net", "sql4499639", "qyQLBwz3M6", "sql4499639");
...
function sendMail($usuario, $sha1)
{
    ...
    $ContrasenaDelCorreo = 'gvuorvuzojchyajy'; // SMTP password
    $SendFromEMAIL = 'briancesi1@gmail.com'; // SMTP username
    $QuienLoEnviaNAME = 'moderator';
    $SendFromEMAILreply = 'briancesi1@gmail.com';
